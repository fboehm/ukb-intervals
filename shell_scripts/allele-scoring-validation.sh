...
#SBATCH --job-name=allele-val
#SBATCH --mem=2G
#SBATCH --array=1-1100%100
#SBATCH --output=/net/mulan/home/fredboe/research/ukb-intervals/cluster_outputs/allele-scoring-val_%a.out
#SBATCH --error=/net/mulan/home/fredboe/research/ukb-intervals/cluster_outputs/allele-scoring-val_%a.err
...
bfile=~/research/ukb-intervals/dat/simulations-ding/validation/impute/chr${chr}
...
preddbslmmt=~/research/ukb-intervals/dat/simulations-ding/validation/allele-scores/pred_ukb_pheno${p}_fold${fold}_chr${chr}_best.dbslmm.txt
