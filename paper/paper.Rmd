...
new methods for genetic predictions (polygenic scores, PGS) of quantitative and binary 
complex traits in humans. A PGS for a trait of interest is calculated by summing the . As such, a PGS is a statistic, a function of the observed data. Recent research has demonstrated large uncertainties associated with PGS. Yet, most current PGS methods provide only point estimates. In this 
