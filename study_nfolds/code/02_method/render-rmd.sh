...
#SBATCH --mem=4G
#SBATCH --output=/net/mulan/home/fredboe/research/ukb-intervals/cluster_outputs/rmd2_%a.out
#SBATCH --error=/net/mulan/home/fredboe/research/ukb-intervals/cluster_outputs/rmd2_%a.err
#SBATCH --array=1-150
