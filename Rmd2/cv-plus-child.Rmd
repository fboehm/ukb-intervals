...
for (cross_num in 1:5){
  ...
  if (trait_type == "continuous") {
    ...
    idx_fn <- paste0("~/research/comparisonProject/02_pheno/04_test_idx_b/idx_pheno", phe_num, "_cross", cross_num, ".txt")
  }
...
if (trait_type == "continuous"){
  ...
  fn <- paste0("~/research/ukb-intervals/03_subsample/binary/pheno", phe_num, "/verif/ukb/02_pheno_b.txt")
}
