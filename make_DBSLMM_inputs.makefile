...
dat/02_pheno/02_train_c$(wildcard *.txt) \
dat/02_pheno/03_test_c$(wildcard *.txt) &: Rscript/03_get_cross_sample.R \
/net/mulan/disk2/yasheng/comparisonProject/02_pheno/01_sqc.RData \
dat/04_pheno_c_adj.rds
	Rscript '$<'


dat/plink_files/genotype/chr$(wildcard *.bed) \
dat/plink_files/genotype/chr$(wildcard *.bim) \
dat/plink_files/genotype/chr$(wildcard *.fam) &: shell_scripts/04_transformat_plink.sh \
