...
idxagg=${compstr}03_subsample/binary/pheno${p}/agg/01_idx.txt

# # sblup
# esteffsblup=${compstr}06_internal_b/pheno${p}/sblup/esteff_hm3_cross${cross}_chr${chr}.sblup.cojo
# # predsblup=${compstr}06_internal_b/pheno${p}/sblup/pred_hm3_cross${cross}_chr${chr}
# aggsblup=${compstr}06_internal_b/pheno${p}/sblup/agg_hm3_cross${cross}_chr${chr}
...
# # predlassosum=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/lassosum/pred_hm3_cross${cross}_chr${chr}
# agglassosum=${compstr}06_internal_b/pheno${p}/lassosum/agg_hm3_cross${cross}_chr${chr}
...
# # preddbslmmt=${compstr}06_internal_b/pheno${p}/DBSLMM/pred_hm3_best_cross${cross}_chr${chr}
# aggdbslmmt=${compstr}06_internal_b/pheno${p}/DBSLMM/agg_hm3_cross${cross}_chr${chr}_best
...
# DBSLMM
esteffdbslmm=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/DBSLMM/summary_hm3_cross${cross}_chr${chr}_auto.dbslmm.txt
preddbslmm=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/DBSLMM/pred_hm3_cross${cross}_chr${chr}_auto
...
# # SbayesR
# esteffsbayesr=${compstr}06_internal_b/pheno${p}/SbayesR/esteff_cross${cross}_chr${chr}
# # predsbayesr=${compstr}06_internal_b/pheno${p}/SbayesR/pred_cross${cross}_chr${chr}
# aggsbayesr=${compstr}06_internal_b/pheno${p}/SbayesR/agg_cross${cross}_chr${chr}
...
# # predCT=${compstr}06_internal_b/pheno${p}/CT/pred_hm3_cross${cross}_chr${chr}
# # predSCT=${compstr}/06_internal_b/pheno${p}/SCT/pred_hm3_cross${cross}_chr${chr}
# aggCT=${compstr}06_internal_b/pheno${p}/CT/agg_hm3_cross${cross}_chr${chr}
# aggSCT=${compstr}06_internal_b/pheno${p}/SCT/agg_hm3_cross${cross}_chr${chr}
...
# # predprscs=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/PRScs/pred_cross${cross}_chr${chr}_best
# aggprscs=${compstr}06_internal_b/pheno${p}/PRScs/agg_cross${cross}_chr${chr}_best
...
# PRScs-auto
esteffprscs=${compstr}06_internal_b/pheno${p}/PRScs/esteff_cross${cross}_chr${chr}_auto.txt
predprscs=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/PRScs/pred_cross${cross}_chr${chr}_auto
aggprscs=${compstr}06_internal_b/pheno${p}/PRScs/agg_cross${cross}_chr${chr}_best
gunzip ${esteffprscs}.gz
plink-1.9 --silent --bfile ${bfile} --score ${esteffprscs} 2 4 6 sum --keep ${idxtest} --out ${predprscs}
plink-1.9 --silent --bfile ${bfile} --score ${esteffprscs} 2 4 6 sum --keep ${idxagg} --out ${aggprscs}
...
# # LDpred2
# esteffLDpred2=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/LDpred2/esteff_hm3_cross${cross}_chr${chr}.txt
# # predLDpred2inf=${compstr1}06_internal_b/pheno${p}/LDpred2/pred_inf_hm3_cross${cross}_chr${chr}
# # predLDpred2sp=${compstr1}06_internal_b/pheno${p}/LDpred2/pred_sp_hm3_cross${cross}_chr${chr}
# # predLDpred2nosp=${compstr1}06_internal_b/pheno${p}/LDpred2/pred_nosp_hm3_cross${cross}_chr${chr}
# # predLDpred2auto=${compstr1}06_internal_b/pheno${p}/LDpred2/pred_auto_hm3_cross${cross}_chr${chr}
# aggLDpred2inf=${compstr}06_internal_b/pheno${p}/LDpred2/agg_inf_hm3_cross${cross}_chr${chr}
# aggLDpred2sp=${compstr}06_internal_b/pheno${p}/LDpred2/agg_sp_hm3_cross${cross}_chr${chr}
# aggLDpred2nosp=${compstr}06_internal_b/pheno${p}/LDpred2/agg_nosp_hm3_cross${cross}_chr${chr}
# aggLDpred2auto=${compstr}06_internal_b/pheno${p}/LDpred2/agg_auto_hm3_cross${cross}_chr${chr}
...
# NPS
esteffnps=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/nps/est/esteff_cross${cross}_chr${chr}.txt
prednps=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/nps/est/pred_cross${cross}_chr${chr}
aggnps=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/nps/est/agg_cross${cross}_chr${chr}
