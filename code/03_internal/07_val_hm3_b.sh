...
# predbagging=${compstr}06_internal_b/pheno${p}/bagging/val_cross${cross}_chr${chr}
...
# # lassosum
# estefflassosum=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/lassosum/esteff_hm3_cross${cross}.txt
# predlassosum=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/lassosum/val_hm3_cross${cross}_chr${chr}
...
# # CT and SCT
# esteffCT=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/CT/esteff_hm3_cross${cross}.txt
# esteffSCT=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/SCT/esteff_hm3_cross${cross}.txt
# predCT=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/CT/val_hm3_cross${cross}_chr${chr}
# predSCT=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/SCT/val_hm3_cross${cross}_chr${chr}
...
# # DBSLMM-t
# esteffdbslmmt=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/DBSLMM/summary_hm3_cross${cross}_chr${chr}_best.dbslmm.txt
# preddbslmmt=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/DBSLMM/val_hm3_best_cross${cross}_chr${chr}
...
preddbslmm=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/DBSLMM/val_hm3_cross${cross}_chr${chr}_auto
...
# predLDpred2inf=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/LDpred2/val_inf_hm3_cross${cross}_chr${chr}
# predLDpred2sp=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/LDpred2/val_sp_hm3_cross${cross}_chr${chr}
# predLDpred2nosp=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/LDpred2/val_nosp_hm3_cross${cross}_chr${chr}
# predLDpred2auto=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/LDpred2/val_auto_hm3_cross${cross}_chr${chr}
...
# # SBLUP
# esteffsblup=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/sblup/esteff_hm3_cross${cross}_chr${chr}.sblup.cojo
# predsblup=/net/mulan/disk2/yasheng/comparisonProject/06_internal_b/pheno${p}/sblup/val_hm3_cross${cross}_chr${chr}
