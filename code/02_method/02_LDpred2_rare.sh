...
#SBATCH --job-name=LDpred2_rare
#SBATCH --mem=30G
#SBATCH --cpus-per-task=2
#SBATCH --array=1-2530%700
#SBATCH --output=/net/mulan/disk2/yasheng/comparisonProject/00_cluster_file/02_LDpred2_rare_2%a.out
#SBATCH --error=/net/mulan/disk2/yasheng/comparisonProject/00_cluster_file/02_LDpred2_rare_2%a.err
