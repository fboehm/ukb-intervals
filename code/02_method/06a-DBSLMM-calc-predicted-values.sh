...
esteffdbslmmt=~/research/ukb-intervals/results/pheno1/yangdbslmm/summary_ukb_cross${cross}_chr${chr}_auto.dbslmm.txt
#preddbslmmt=${compstr}05_internal_c/pheno${p}/DBSLMM/pred_hm3_best_cross${cross}_chr${chr}
preddbslmmt=~/research/ukb-intervals/results/pheno1/yangdbslmm/predicted_ukb_cross${cross}_chr${chr}_auto.dbslmm.txt
