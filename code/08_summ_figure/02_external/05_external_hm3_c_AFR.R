...
# ext r2 dat
ext_r2_list <- alply(c(1:25), 1, function(a){
  dat_str <- paste0(comp_str, "07_external_c/01_AFR/04_summ_res/res_hm3_c_pheno", 
                    a, "_dat1.RData")
  load(dat_str)
  return(r2_mat)
})
...
save(ext_r2_mean_dat, file = paste0(comp_str, 
                                    "07_external_c/01_AFR/04_summ_res/ext_r2_hm3_c_mean_dat.RData"))
save(ext_r2_dat, file = paste0(comp_str, 
                               "07_external_c/01_AFR/04_summ_res/ext_r2_hm3_c_dat.RData"))
save(ext_r2_percent2, file = paste0(comp_str, 
                                    "07_external_c/01_AFR/04_summ_res/ext_r2_hm3_c_percent2.RData"))
save(ext_r2_percent2_pheno, file = paste0(comp_str, 
                                          "07_external_c/01_AFR/04_summ_res/ext_r2_hm3_c_percent2_pheno.RData"))
