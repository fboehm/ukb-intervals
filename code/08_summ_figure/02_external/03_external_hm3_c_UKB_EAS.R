...
pheno_uni <- c("SH_UKB", "PLT_UKB", "BMD", "BMR", "BMI_UKB", 
               "RBC_UKB", "AM_UKB", "RDW", "EOS_UKB", "WBC_UKB", 
               "FVC", "FEV", "FFR", "WC", "HC", 
               "WHR", "SBP_UKB", "BW", "BFP", "TFP", 
               "SU", "TC_UKB", "HDL_UKB","LDL_UKB", "TG_UKB")
pheno_order <- c("SH_UKB", "BMD", "HDL_UKB", "BMR", "PLT_UKB",
                 "BMI_UKB","BFP", "AM_UKB", "HC", "RBC_UKB",
                 "TFP", "RDW","WC", "EOS_UKB", "TG_UKB",
                 "WBC_UKB", "FVC", "FFR", "FEV", "WHR",
                 "SBP_UKB", "TC_UKB", "LDL_UKB", "BW", "SU")
...
ext_r2_list <- alply(iter_str, 1, function(iter){
  dat_str <- paste0(comp_str, "07_external_c/03_EAS/04_summ_res/res_hm3_c_pheno",
...
save(ext_r2_mean_dat, file = paste0(comp_str, 
                                    "07_external_c/03_EAS/04_summ_res/ext_r2_hm3_c_mean_dat_UKB.RData"))
save(ext_r2_dat, file = paste0(comp_str, 
                               "07_external_c/03_EAS/04_summ_res/ext_r2_hm3_c_dat_UKB.RData"))
save(ext_r2_percent2, file = paste0(comp_str, 
                                    "07_external_c/03_EAS/04_summ_res/ext_r2_hm3_c_percent2_UKB.RData"))
save(ext_r2_percent2_pheno, file = paste0(comp_str, 
                                          "07_external_c/03_EAS/04_summ_res/ext_r2_hm3_c_percent2_pheno_UKB.RData"))
