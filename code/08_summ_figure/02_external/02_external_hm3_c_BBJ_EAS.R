...
pheno_uni <- c("SH_BBJ", "PLT_BBJ", "BMI_BBJ",  "RBC_BBJ", "AM_BBJ", 
               "EOS_BBJ", "WBC_BBJ", "SBP_BBJ","TC_BBJ", "HDL_BBJ",
               "LDL_BBJ", "TG_BBJ")
pheno_order <- c("SH_BBJ", "PLT_BBJ", "BMI_BBJ", "RBC_BBJ",  "AM_BBJ",
                 "EOS_BBJ", "WBC_BBJ", "SBP_BBJ",  "TC_BBJ", "HDL_BBJ",
                 "LDL_BBJ", "TG_BBJ")
...
save(ext_r2_mean_dat, file = paste0(comp_str, 
                                    "07_external_c/03_EAS/04_summ_res/ext_r2_hm3_c_mean_dat_BBJ.RData"))
save(ext_r2_dat, file = paste0(comp_str, 
                               "07_external_c/03_EAS/04_summ_res/ext_r2_hm3_c_dat_BBJ.RData"))
save(ext_r2_percent2, file = paste0(comp_str, 
                                    "07_external_c/03_EAS/04_summ_res/ext_r2_hm3_c_percent2_BBJ.RData"))
save(ext_r2_percent2_pheno, file = paste0(comp_str, 
                                          "07_external_c/03_EAS/04_summ_res/ext_r2_hm3_c_percent2_pheno_BBJ.RData"))
