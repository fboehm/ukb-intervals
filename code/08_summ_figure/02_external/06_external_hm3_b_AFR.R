...
ext_auc_list <- alply(c(1: 25), 1, function(p){
  dat_str <- paste0(comp_str, "07_external_c/01_AFR/04_summ_res/res_hm3_b_pheno",
                    p, "_dat1.RData")
  load(dat_str)
...
save(ext_auc_dat, file = paste0(comp_str, "07_external_c/01_AFR/04_summ_res/ext_auc_hm3_b_dat.RData"))
...
save(ext_auc_mean_dat, file = paste0(comp_str, 
                                     "07_external_c/01_AFR/04_summ_res/ext_auc_hm3_b_mean_dat.RData"))
save(ext_auc_dat, file = paste0(comp_str, 
                                "07_external_c/01_AFR/04_summ_res/ext_auc_hm3_b_dat.RData"))
save(ext_auc_percent2, file = paste0(comp_str, 
                                     "07_external_c/01_AFR/04_summ_res/ext_auc_hm3_b_percent2.RData"))
