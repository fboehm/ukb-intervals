...
blk_str <- paste0(comp_str, "09_external_LD/AA/")
blk_info <- fread2(paste0(comp_str, "LDblock_AA/chr", chr, ".bed"), select = c(2, 3))
...
save(LD_list, file = paste0(comp_str, "09_external_LD/AA/LDmat/chr", chr, ".RData"))
