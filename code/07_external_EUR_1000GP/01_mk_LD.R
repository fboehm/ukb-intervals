...
blk_str <- paste0(comp_str, "09_external_LD/EUR/")
blk_info <- fread2(paste0(comp_str, "LDblock_EUR/chr", chr, ".bed"), select = c(2, 3))
...
save(LD_list, file = paste0(comp_str, "09_external_LD/EUR/LDmat/chr", chr, ".RData"))
