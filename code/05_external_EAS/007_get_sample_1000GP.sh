...
mkLD=/net/mulan/disk2/yasheng/comparisonProject/code/05_external_EAS/02_mk_LD.R
...
IDFILE=/net/mulan/disk2/yasheng/comparisonProject/09_external_LD/EAS_id.txt
SNPFILE=/net/mulan/disk2/yasheng/predictionProject/plink_file/snplist.txt
OUTFILE2=/net/mulan/disk2/yasheng/comparisonProject/09_external_LD/EAS/geno/chr${chr}
