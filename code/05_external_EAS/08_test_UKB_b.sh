...
predbagging=${compstr}07_external_c/03_EAS/03_res/binary/pheno${p}_data1/bagging/pred_hm3_cross${cross}_chr${chr}
...
predsblup=${compstr}07_external_c/03_EAS/03_res/binary/pheno${p}_data1/sblup/pred_hm3_cross${cross}_chr${chr}
...
predlassosum=${compstr}07_external_c/03_EAS/03_res/binary/pheno${p}_data1/lassosum/pred_hm3_cross${cross}_chr${chr}
...
predCT=${compstr}07_external_c/03_EAS/03_res/binary/pheno${p}_data1/CT/pred_hm3_cross${cross}_chr${chr}
predSCT=${compstr}07_external_c/03_EAS/03_res/binary/pheno${p}_data1/SCT/pred_hm3_cross${cross}_chr${chr}
...
predLDpred2inf=${compstr}07_external_c/03_EAS/03_res/binary/pheno${p}_data1/LDpred2/pred_inf_hm3_cross${cross}_chr${chr}
predLDpred2sp=${compstr}07_external_c/03_EAS/03_res/binary/pheno${p}_data1/LDpred2/pred_sp_hm3_cross${cross}_chr${chr}
predLDpred2nosp=${compstr}07_external_c/03_EAS/03_res/binary/pheno${p}_data1/LDpred2/pred_nosp_hm3_cross${cross}_chr${chr}
predLDpred2auto=${compstr}07_external_c/03_EAS/03_res/binary/pheno${p}_data1/LDpred2/pred_auto_hm3_cross${cross}_chr${chr}
...
prednps=${compstr}07_external_c/03_EAS/03_res/binary/pheno${p}_data1/nps/pred_cross${cross}_chr${chr}
...
esteffdbslmmt=${compstr}07_external_c/03_EAS/03_res/binary/pheno${p}_data1/DBSLMM/summary_hm3_cross${cross}_chr${chr}_best.dbslmm.txt
preddbslmmt=${compstr}07_external_c/03_EAS/03_res/binary/pheno${p}_data1/DBSLMM/pred_hm3_best_cross${cross}_chr${chr}
...
predprscs=${compstr}07_external_c/03_EAS/03_res/binary/pheno${p}_data1/PRScs/pred_cross${cross}_chr${chr}_best
...
predsbayesr=${compstr}07_external_c/03_EAS/03_res/binary/pheno${p}_data1/SbayesR/pred_cross${cross}_chr${chr}
