...
pp <- h_tib %>% 
  ...
  ggplot2::ggplot() + ggplot2::geom_violin(ggplot2::aes(x = mean_herit, y = interval_width, group = trait_num, colour = as.factor(trait_num), label = trait_num), show.legend = FALSE) 
pp %>%
