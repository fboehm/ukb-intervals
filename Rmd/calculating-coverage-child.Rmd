...
test_indicator <- readr::read_table(file = "~/research/ukb-intervals/test_indicator_files/test_indicator_pheno_", phe_num, "_cross_", cross_num, "_ntest1000.txt", col_names = FALSE)
