...
res_list <- list()
for (i in 1:22){
  res_list[[i]] <- readr::read_table(paste0("/net/mulan/disk2/fredboe/research/ukb-intervals/results/pheno", phe_num, "/summary_ukb_cross", cross_num, "_variance_chr", i, ".txt"), col_names = FALSE, skip = 2)
}
# fix column names
for (chr in 1:22){
...
test_indicator <- readr::read_table(file = paste0("/net/mulan/disk2/fredboe/research/ukb-intervals/test_indicator_files/test_indicator_pheno_", phe_num, "_cross_", cross_num, "_ntest1000.txt"), col_names = FALSE)
```
...
scores <- list()
for (i in 1:22){
  fn <- paste0("/net/mulan/disk2/fredboe/research/ukb-intervals/results/pheno", phe_num, "/predicted_ukb_cross", cross_num, "_chr", i, "_auto.dbslmm.txt.profile")
...
fam4
vroom::vroom_write(x = fam4,
                  file = paste0("results_trait", phe_num, ".txt"))
