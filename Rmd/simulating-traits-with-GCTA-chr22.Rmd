...
We next need to divide the subjects into training, validation, verification, and test subjects.
...
```{r}
settings <- tibble::tibble(hsq = c(0.2, 0.2, 0.2, 0.1, 0.5), p_causal = c(0.1, 0.01, 1, 0.1, 0.1))
