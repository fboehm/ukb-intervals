...
phe_num <- x
fam_file <- here::here("dat/simulations-ding/gemma_hsq0.2_pcausal0.001/chr1.fam")
...
for (cross_num in 1:5){
  ...
  for (chr_num in 1:22){
    ...
    fn <- paste0("~/research/ukb-intervals/dat/simulations-ding/verification/allele-scores_hsq0.2_pcausal0.001/pred_ukb_pheno", phe_num, "_fold", cross_num, "_chr", chr_num, "_best.dbslmm.txt.profile")
