...
for (cross_num in 1:5){
  ...
  for (chr_num in 1:22){
    ...
    fn <- paste0("~/research/ukb-intervals/dat/simulations-ding/verification/allele-scores/pred_ukb_pheno", phe_num, "_fold", cross_num, "_chr", chr_num, "_best.dbslmm.txt.profile")
