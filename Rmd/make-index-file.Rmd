...
fam <- readr::read_delim("~/research/ukb-intervals/dat/plink_files/ukb/pheno1/chr1.fam", col_names = FALSE)
...
fam_nona[!(1:nrow(fam_nona) %in% training_indices), 6:ncol(fam_nona)] <- NA
